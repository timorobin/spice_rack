...
def file_system() -> fs_ops.file_systems.GcsFileSystem:
    auth_strat = gcp_auth.auth_strategies.AnonAuthStrategy()
...
@pytest.fixture(scope="module")
def work_dir(public_bucket, file_system) -> fs_ops.path_strs.AbsoluteDirPathStr:
    p = public_bucket + "test_dir/"
